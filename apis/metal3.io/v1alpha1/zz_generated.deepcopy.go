...
func (in *BareMetalHostSpec) DeepCopyInto(out *BareMetalHostSpec) {
	*out = *in
	...
	if in.VendorFirmware != nil {
		in, out := &in.VendorFirmware, &out.VendorFirmware
		*out = new(VendorFirmware)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UpdateNvidiaFirmware) DeepCopyInto(out *UpdateNvidiaFirmware) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UpdateNvidiaFirmware.
func (in *UpdateNvidiaFirmware) DeepCopy() *UpdateNvidiaFirmware {
	if in == nil {
		return nil
	}
	out := new(UpdateNvidiaFirmware)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VendorFirmware) DeepCopyInto(out *VendorFirmware) {
	*out = *in
	if in.UpdateNvidiaFirmware != nil {
		in, out := &in.UpdateNvidiaFirmware, &out.UpdateNvidiaFirmware
		*out = new(UpdateNvidiaFirmware)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VendorFirmware.
func (in *VendorFirmware) DeepCopy() *VendorFirmware {
	if in == nil {
		return nil
	}
	out := new(VendorFirmware)
